                        ...
                        <div className="footer-blocks__card fullheight-card">
                            ...
                            <div className="footer-blocks__nav">
                                <ul className="footer-nav">
                                    ...
                                    <li className="footer-nav__item anim-uni-in-up">
                                        <a href="#references" className="footer-nav__link btn-anim">
                                            <span className="btn-caption">{t.footer.references}</span>
                                        </a>
                          ...
                          c0,0,1.3-0.1,1.8-0.2c1,0,4,0,4,0c0.2,0,0.4-0.2,0.4-0.4C20,9.8,19.8,9.6,19.6,9.6L19.6,9.6z"
                                    ...
                                    <li className="footer-nav__item anim-uni-in-up">
                                        <a href="#0" className="footer-nav__link btn-anim">
                                            <span className="btn-caption">{t.footer.services}</span>
                                        </a>
                                    </li>
                                    <li className="footer-nav__item anim-uni-in-up">
                                        <a href="#0" className="footer-nav__link btn-anim">
                                            <span className="btn-caption">{t.footer.insights}</span>
                                        </a>
                                    </li>
                                    <li className="footer-nav__item anim-uni-in-up">
                                        <a
                    ...
                    c0,0,1.3-0.1,1.8-0.2c1,0,4,0,4,0c0.2,0,0.4-0.2,0.4-0.4C20,9.8,19.8,9.6,19.6,9.6L19.6,9.6z"
                        ...
                        <div className="footer-blocks__card fill-card notify">
                            ...
                            <div className="footer-blocks__title anim-uni-in-up">
                                <p className="footer-blocks__title-m">{t.footer.subscribe}</p>
                            </div>
                            {/* subscribe form container */}
                            <div className="form-container anim-uni-in-up">
                                {/* reply messages */}
                                <div className="form__reply subscription-ok">
                                    <span className="reply__text">{t.footer.done}</span>
                                </div>
                                <div className="form__reply subscription-error">
                                    <span className="reply__text">{t.footer.error}</span>
                                </div>
                                {/* subscribe form */}
                    ...
                    <div className="footer-blocks__column animate-card-3">
                        ...
                        <div className="footer-blocks__card fullheight-card">
                            ...
                            <div className="footer-blocks__block">
                                {/* card title */}
                                <div className="footer-blocks__title anim-uni-in-up">
                                    <p className="footer-blocks__title-l">{t.footer.ecosystem}</p>
                                </div>
                                {/* footer socials */}
